...
fe = 1000;
N = 10*1;
t = (1/fe:1/fe:N);      % this will be used to compute IMU data
t0 = (0:1/fe:N-1/fe);   % this will be used to define the trajectory
%once at the initial position, using sinus  gives a first imu data vector
%of [0;0;0;0;0;0]. This is not true ! At initial pose we must take into
%account both initial conditions and the dynamic of the system. First data
%will not be [0;0;0;0;0;0] but the one we will get at 1/fe. This reduces
%the errors in position but the state of the system will be in advance from
%what we should have.
