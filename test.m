...
%ax = 6*sin(2*pi*f_ax*t);
ax(1,1:(N*fe)) = 0;
ax(1,1) = 20;
ax(1,2) = 10;
ax(1,1:100:(N*fe)) = 10;
ay = 0*t; %6*sin(2*pi*f_ay*t);
az = 0*t; %6*sin(2*pi*f_az*t);
wx = 0*t;
wy = 0*t;
wz = 0*t; %6*sin(2*pi*f_wz*t);
wy(1,1:(N*fe)) = 12*deg_to_rad; 
%wx(1,1:30000) = 20; 
%wz(1,1:30000) = 12*deg_to_rad;%6*sin(2*pi*f_wz*t);
%wx = cos(2*pi*f_wx*t);
%wy = cos(2*pi*f_wy*t);
%wz = cos(2*pi*f_wz*t);
